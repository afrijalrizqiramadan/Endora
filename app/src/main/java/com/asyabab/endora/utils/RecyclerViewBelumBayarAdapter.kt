...
class RecyclerViewBelumBayarAdapter internal constructor(
    var context: Context,
    private val subItemList: List<Order>
) : RecyclerView.Adapter<RecyclerViewBelumBayarAdapter.ViewHolder>() {
