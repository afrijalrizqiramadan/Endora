...
class RecyclerViewDibatalkanAdapter internal constructor(
    var context: Context,
    private val subItemList: List<Order____>
) : RecyclerView.Adapter<RecyclerViewDibatalkanAdapter.ViewHolder>() {
